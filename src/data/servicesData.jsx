...
export const servicesData = [
  {
    ...
    content: (
      <>
        ...
        <p>As leading <strong>event organizers in Jammu</strong>, we bring over 15 years of experience to the table. Our local knowledge of Jammu, Kathua, Udhampur, and Srinagar allows us to source the best venues, vendors, and materials. We blend professionalism with a personal touch, ensuring every aspect of your wedding, from the food to the decor, is nothing short of perfection. Our reputation as the <strong><a href="https://ggcaterers.com/blog/best-caterers-in-jammu-complete-guid" className="text-orange-300 underline">best catering services in Jammu</a></strong> means your guests will be treated to an unforgettable culinary journey.</p>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><strong>Ritual Coordination:</strong> Seamless management of all ceremonies, from <a href="https://ggcaterers.com/blog/festival-event-management-jammu" className="text-orange-300 underline">Mehendi and Sangeet to the Wedding and Reception</a>.</li>
        </ul>
