...
const jammuHalls = [
  ...
  { name: "Royal Estate Banquet", location: "Akhnoor Road, Toph Sherkhanian, Jammu 180003", contact: "+91-9419165817", capacity: "100-600 guests", why: "Spacious venue in a strategic location for weddings & receptions.", photo: "Available online" },
  { name: "Anutham Hotel & Resorts", location: "Bypass Kunjwani near Vishal Megamart, Opposite Audi Showroom, Jammu 180010", contact: "+91-7006619731", capacity: "150-600 guests", why: "Resort-style hotel venue with banquet facilities and premium amenities.", photo: "Available online" },
  { name: "Reen Palace", location: "Karan Bagh Road, Chatha, Gadigarh, Jammu 181101", contact: "+91-9419140686", capacity: "500-1500 guests", why: "Large venue ideal for grand weddings, high guest capacity.", photo: "Available online" },
  { name: "Karan Palace", location: "Near TV Tower, Akhnoor Road, Nagbani, Jammu 181206", contact: "+91-9419206285", capacity: "500-1000 guests", why: "Well-known venue for big ceremonies and receptions.", photo: "Available online" },
  { name: "Zone by The Park", location: "Rail Head Complex, Trikuta Nagar, Jammu 180012", contact: "+91-1912471922", capacity: "200-300 guests", why: "Prestigious hotel venue in Jammu city with banquet hall facilities.", photo: "Available online" },
  { name: "Bawa Palace", location: "Axis Bank, Srinagar-Anyakumari Hwy, Tarore, Bari Brahmana, Jammu 181133", contact: "+91-7006280914", capacity: "350-500 guests", why: "Banquet hall near industrial zone, good for medium-large events.", photo: "Available online" },
  { name: "KC Residency – Banquets", location: "Rajpura Chungi, Jammu", contact: "Via venue site", capacity: "Large multipurpose hall", why: "Multipurpose banquet facility under hotel brand, trustworthy.", photo: "Available online" },
  ...
  { name: "The Address Banquet", location: "Purmandal More, Kalu Chak, Jammu - 180010", contact: "Via listing (showing on site) :contentReference[oaicite:4]{index=4}", capacity: "Medium-Large", why: "Accessible location near city, popular among local weddings.", photo: "Available online"}
];

const sambaHalls = [
  { name: "Apna Banquet Hall", location: "National Highway, Jakh, near Lord Shiva Temple, Vijaypur, Samba", contact: "+91-70069-74236", capacity: "Medium", why: "Well-known hall in Samba district; accessible location for local weddings", photo: "Available online" },
  { name: "Balaji Banquet Hall", location: "Gowal Patli Morh, Samba", contact: "Available online", capacity: "Medium", why: "Local banquet hall for mid-sized gatherings in Samba", photo: "Available online" },
  { name: "Tera Farms", location: "Nanak Chak, Vijaypur region, Samba", contact: "Available via listing", capacity: "Lawn / open-air style", why: "Open-air farm venue near Samba; good for larger functions", photo: "Available online" },  
  { name: "Satyam R.K Resort", location: "NH-44, Jatwal, Opposite HP Petrol Pump, Jammu / Samba region", contact: "Via listing on Shuru – 4★ rating", capacity: "Large lawn + banquet hall", why: "Resort style venue with both hall and lawn in Samba area", photo: "Available online" },
  { name: "BMS Farm", location: "Sumb, Samba district, Jammu & Kashmir 184121", contact: "Via Justdial listing", capacity: "Medium", why: "AC banquet hall listed for Samba district", photo: "Available online" },
  { name: "The Samba Fort Banquet & Resorts", location: "Sumb Road, Kotli, Samba", contact: "Via local listing", capacity: "Large", why: "Banquet & resort venue near Samba town; good for bigger weddings", photo: "Available online" },
  ...
  { name: "RR Resort Samba", location: "Sumb Road, Kotli, Samba District, Jammu & Kashmir", contact: "(See listing) +--", capacity: "Large", why: "Resort-style banquet & outdoor space in Samba for large weddings. :contentReference[oaicite:4]{index=4}", photo: "Available online"}
];
...
const srinagarHalls = [
  ...
  { name: "Sheesha Marriage Hall",  location: "Nowshera, Srinagar, Jammu & Kashmir 190011",  contact: "+91-95960-67895",  capacity: "Large hall + parking area", why: "Popular for large wedding gatherings; elegant interiors", photo: "Available online"},
  { name: "Khyber Banquet Hall", location: "Hyderpora Bypass, Srinagar, JK 190014", contact: "+91-70062-44889", capacity: "Medium-Large", why: "Known for good hospitality and convenient location", photo: "Available online"},
  { name: "Heaven Banquet Hall", location: "Chanapora, Srinagar, JK 190015", contact: "Available via Justdial", capacity: "Medium", why: "Well maintained, frequently booked for mid-size weddings", photo: "Available online"},
  { name: "Kashmir Banquet Hall", location: "Rawalpora, Srinagar, Jammu & Kashmir 190005", contact: "+91-96222-99567", capacity: "Medium-Large", why: "Elegant interiors and central location make it ideal for family events", photo: "Available online" },
  { name: "Impex Hill Resorts & Banquet", location: "Nishat, Boulevard Road, Srinagar, JK 190001", contact: "+91-94190-22100", capacity: "Large resort-style hall", why: "Overlooking Dal Lake, perfect for scenic destination weddings", photo: "Available online" },
  { name: "Kashmir Mahal Resorts", location: "Gupkar Road, near Dal Lake, Srinagar, JK 190001", contact: "Via official site", capacity: "Large lawn + hall", why: "Luxury banquet resort; top choice for high-end celebrations", photo: "Available online" },
